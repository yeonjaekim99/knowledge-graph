...
FND-004와 같은 SDK validator로 검증한다. schema/type drift는 같은 이름의 type fixture가
별도 `typecheck:rcl-001`에서 막는다. 실제 tool catalog와 structuredContent wiring은 MCP-003이
소유한다.
