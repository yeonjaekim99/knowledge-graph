...
- active 제품 작업 완료 수는 현재 17/66이다. `FND-001`~`FND-005`, `FND-007`, `STO-001`~`008`과
  `PRJ-001`~`003`이 production artifact와 검증·PR 증거를 갖춰 `DONE`이며 나머지 active 작업은 각
