...
- [x] `RCL-003` | baseline: S01/S11/S22가 safe FTS·TTL·raw 부활 방지 fallback을 확인했다. | production: branch에서 bound quoted query, normalized 3글자 경계, fixed-snapshot FTS 21/20, valid graph seed/reached pin과 raw-only·duplicate 억제를 구현했으며 PR review와 `main` merge 증거는 아직 남아 있다.
...
- Phase 01은 6/6, Phase 02는 8/8, Phase 03은 10/10으로 종료됐다. `REC-001`~`REC-003`과
  `RCL-001`~`RCL-002`는 완료됐고 `REC-004`, `RCL-003`, `RCL-005`는 owner와 격리
  branch에서 진행 중이다.
