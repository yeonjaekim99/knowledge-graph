...
> 현재 상태: **Phase 02 진행 중 · STO-001~003 완료, STO-004·STO-005 착수 가능**
...
| 02 | [SQLite·저널](02-storage.md) | `IN_PROGRESS` | 3/8 | Phase 01 `DONE` | migration, scope, writer, journal |
