...
> 현재 상태: **Phase 04와 Phase 06 병렬 진행 중 · REC-001~004/RCL-001~006 완료, REC-005/RCL-007 진행 중**
...
[PR #39](https://github.com/yeonjaekim99/knowledge-graph/pull/39), RCL-003은
[PR #41](https://github.com/yeonjaekim99/knowledge-graph/pull/41), REC-004는
[PR #43](https://github.com/yeonjaekim99/knowledge-graph/pull/43), RCL-004는
[PR #45](https://github.com/yeonjaekim99/knowledge-graph/pull/45), RCL-005는
[PR #46](https://github.com/yeonjaekim99/knowledge-graph/pull/46), RCL-006은
[PR #49](https://github.com/yeonjaekim99/knowledge-graph/pull/49)의 구현·독립 review·전체
회귀와 상태 증거로 완료했다. REC-005는 격리 branch에서 진행한다. RCL-007도 선행 작업이
완료돼 `rcl-007-answer-budget` 격리 branch를 예약했으며 REC-005와 병렬로 진행한다. 병합
...
| 02 | [SQLite·저널](02-storage.md) | `DONE` | 8/8 | Phase 01 `DONE` | migration, scope, writer, journal |
| 03 | [투영·재생](03-projection.md) | `DONE` | 10/10 | Phase 02 `DONE` | 증분/전체 replay parity |
| 04 | [`memory_record`](04-memory-record.md) | `IN_PROGRESS` | 4/8 | Phase 03 `DONE` | 안전한 기록 수직 경로 |
| 05 | [`memory_revise`](05-memory-revise.md) | `TODO` | 0/7 | Phase 04 `DONE` | 철회·교정·병합·별칭 |
| 06 | [`memory_recall`](06-memory-recall.md) | `IN_PROGRESS` | 6/9 | Phase 03 `DONE` | FTS·그래프·랭킹·응답 |
