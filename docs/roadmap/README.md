...
> 현재 상태: **Phase 03 진행 중 · PRJ-005 entity·surface·kind 투영 구현 중**
...
| 03 | [투영·재생](03-projection.md) | `IN_PROGRESS` | 4/10 | Phase 02 `DONE` | 증분/전체 replay parity |
