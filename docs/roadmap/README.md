...
> 현재 상태: **Phase 04와 Phase 06 병렬 진행 중 · REC-001 완료, REC-002/REC-004/RCL-001 진행 중**
...
| 06 | [`memory_recall`](06-memory-recall.md) | `IN_PROGRESS` | 0/9 | Phase 03 `DONE` | FTS·그래프·랭킹·응답 |
